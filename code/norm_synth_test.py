...
plt.savefig('figures/norm_llh_trace',format='pdf')
clf()
...
plt.plot(data,-0.1*ones(data.shape), linestyle = 'none',
         color = 'g', marker = 'x')
#plt.ylim((-0.2,0.8))
plt.savefig('figures/norm_syn_density.pdf', format='pdf')
clf()
