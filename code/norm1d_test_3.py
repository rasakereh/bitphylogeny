...
reader = csv.DictReader(open('./pyclone-data/SRR385938.tsv'),
                        delimiter='\t')
...
#plt.savefig('figures/test_trace_38.pdf',format='pdf')
clf()
...
plt.plot(data,-0.1*ones(data.shape), linestyle = 'none',
         color = 'g', marker = 'x')
#plt.ylim((-0.2,0.8))
#plt.savefig('figures/test_38.pdf', format='pdf')
clf()


filename = 'testgraph_38.gdl'
fh2 = open(filename,'w')
